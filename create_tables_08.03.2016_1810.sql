...
#create table _point_T(_ID_F int not null primary key auto_increment, _time_V_F time)
#create table _place_R_T(_ID_F int not null primary key auto_increment, _point_ID_F int not null, _place_ID_F int not null)
#create table _place_T(_ID_F int not null primary key auto_increment, _coordinates_L_V_F float not null, _coordinates_W_V_F float not null, _nam_V_F varchar(255))
...
#create table _site_R_T(_ID_F int not null primary key auto_increment, _plane_ID_F int not null, _site_ID_F int not null)
